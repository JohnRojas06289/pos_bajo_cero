                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-5 mb-4 mb-lg-0">
                        ...
                        <p style="color:rgba(255,255,255,0.75);font-size:0.9rem;line-height:1.7;margin-bottom:0.5rem;">
                            Calle 9 # 11-41<br>
                            Centro Comercial Lo Nuestro, Local Z715<br>
                            2do piso — Bogotá, Colombia
                        </p>
                        <a href="https://maps.google.com/?q=Calle+9+%2311-41+Centro+Comercial+Lo+Nuestro+Bogota+Colombia"
                    ...
                    <div class="col-lg-7">
                        <div style="border-radius:12px;overflow:hidden;border:1px solid rgba(255,255,255,0.1);">
                            <iframe
                                src="https://maps.google.com/maps?q=Calle+9+%2311-41+Centro+Comercial+Lo+Nuestro+Bogota+Colombia&output=embed&z=17"
