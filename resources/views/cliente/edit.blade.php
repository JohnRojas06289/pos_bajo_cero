...
<div class="container-fluid px-2">
    <h1 class="mt-1 text-center">Editar Cliente</h1>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6 d-flex align-items-end mb-3">
                        <div class="form-check form-switch p-3 bg-white rounded border w-100">
                            <input class="form-check-input ms-0 me-3" type="checkbox" role="switch" name="es_mayorista" id="es_mayorista" value="1" {{ old('es_mayorista', $cliente->persona->es_mayorista) ? 'checked' : '' }} style="width: 3rem; height: 1.5rem;">
